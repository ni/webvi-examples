...
jqx-drop-down-list {
    ...
    jqx-combo-box input:focus,
    jqx-combo-box[drop-down-open-mode="default"] input:focus {
        outline: medium none invert;
        outline: initial;
    }

        jqx-combo-box > .jqx-container > div[focused]:first-child,
        ...
        jqx-combo-box > .jqx-container > div[focused]:first-child .jqx-drop-down-button {
            border-color: #555555;
        }

    jqx-combo-box .jqx-drop-down-button.hovered[selected],
    jqx-combo-box.hovered > .jqx-container > div:first-child,
    jqx-combo-box.hovered > .jqx-container > div[focused]:first-child .jqx-drop-down-button,
    jqx-combo-box[drop-down-open-mode="dropDownButton"].hovered > .jqx-container > div[focused]:first-child,
    ...
    jqx-combo-box > .jqx-container > div:first-child,
...
jqx-combo-box[disabled] > .jqx-container > div:first-child {
    opacity: 0.55;
}
...
jqx-drop-down-list[readonly] .jqx-drop-down-button:active,
jqx-drop-down-list[readonly] > .jqx-container > div:first-child:active,
jqx-drop-down-list[readonly] > .jqx-container > div:first-child.active {
    color: #000;
    color: initial;
    background-color: transparent;
...
jqx-combo-box > .jqx-container > div:first-child[selected] .jqx-drop-down-button,
...
jqx-combo-box.hovered[disabled] input,
jqx-combo-box.hovered[disabled] > .jqx-container > div:first-child,
jqx-combo-box.hovered > .jqx-container > div[selected]:first-child,
...
jqx-combo-box {
    ...
    jqx-combo-box[drop-down-open-mode="dropDownButton"] > .jqx-container > div[focused]:first-child {
        border-color: #A9A9A9;
    }

    jqx-combo-box[drop-down-open-mode="dropDownButton"] .jqx-container > div[focused]:first-child .jqx-selection-field {
        outline-color: #555555;
    }

    jqx-combo-box[drop-down-open-mode="dropDownButton"].hovered .jqx-container > div[focused]:first-child .jqx-selection-field {
    ...
    jqx-combo-box[drop-down-open-mode="dropDownButton"].hovered .jqx-drop-down-button:focus {
        outline-color: transparent;
        border-left: 1px solid #A9A9A9;
    }
...
jqx-check-box {
    ...
    jqx-check-box[disabled] .jqx-container,
    jqx-check-box[disabled] .jqx-label {
        cursor: auto;
        cursor: initial;
    }
