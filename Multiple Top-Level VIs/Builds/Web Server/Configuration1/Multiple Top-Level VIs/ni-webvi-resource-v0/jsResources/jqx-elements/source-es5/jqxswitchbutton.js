...
JQX('jqx-switch-button', function (_JQX$ToggleButton) {
    ...
    babelHelpers.createClass(SwitchButton, [{
        ...
        value: function ready() {
            ...
            that._supportCSSVariables = Boolean(window.getComputedStyle(that.$.container).getPropertyValue('--jqx-switch-button-width'));
        ...
        */
        ...
        value: function _resizeHandler() {
            ...
            if (that._supportCSSVariables) {
                ...
                that.orientation === 'horizontal' ? that.$.innerContainer.style.setProperty('width', 2 * newWidth - that.$.switchThumb.clientWidth + 'px') : that.$.innerContainer.style.setProperty('height', 2 * newWidth - that.$.switchThumb.clientHeight + 'px');
                that.orientation === 'horizontal' ? that.$.trueContentContainer.style.setProperty('width', that._switchTrackLength + 'px') : that.$.trueContentContainer.style.setProperty('height', that._switchTrackLength + 'px');
                that.orientation === 'horizontal' ? that.$.falseContentContainer.style.setProperty('width', that._switchTrackLength + 'px') : that.$.falseContentContainer.style.setProperty('height', that._switchTrackLength + 'px');
                that.orientation === 'horizontal' ? that.$.innerContainer.style.setProperty('height', '100%') : that.$.innerContainer.style.setProperty('width', '100%');
                that.orientation === 'horizontal' ? that.$.trueContentContainer.style.setProperty('height', '100%') : that.$.trueContentContainer.style.setProperty('width', '100%');
                that.orientation === 'horizontal' ? that.$.falseContentContainer.style.setProperty('height', '100%') : that.$.falseContentContainer.style.setProperty('width', '100%');
            }
