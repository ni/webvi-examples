...
To provide feedback to the 375px bounds of `.content-item`, a CSS rule has been added to the WebVI using the HTML source dialog. The HTML source dialog can be accessed by clicking the `Edit panel HTML` button on the toolbar of a Web VI's panel.
